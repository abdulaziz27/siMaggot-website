	...
	return (
		<div className="transaction-page-account-option">
			...
			<div className="transaction-sort-option-container">
				<h2>Status</h2>
				<div className="transaction-sort-option">Semua</div>
				<div className="transaction-sort-option">Belum Dibayar</div>
				<div className="transaction-sort-option">Sedang Dikemas</div>
				<div className="transaction-sort-option">Dikirim</div>
				<div className="transaction-sort-option">Selesai</div>
				<div className="transaction-sort-option">Dibatalkan</div>
			</div>
			...
			<div className="transaction-item-account-container">
				...
				<div className="item-transaction-information-contanier">
					...
					<div className="item-transaction">
						<div className="row-direction-item-transaction">
							...
							<div className="item-transaction-information">
								<h1>
									Premium Dried Maggot / Maggot Kering BSF
									Flake
								</h1>
								<p>Variasi : 100gr</p>
								<h2>x1</h2>
				...
				<div className="transaction-item-account-footer">
					...
					<div className="payment-time-button-container">
						<p>
							Bayar sebelum <u>09-11-2023 00:00</u> dengan Bank
							BNI
						</p>
