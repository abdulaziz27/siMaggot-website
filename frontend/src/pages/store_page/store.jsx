...
import { getSellerProducts, addProductToCart } from '../../api';
            ...
            {currentView === "products" && (
              ...
              <div className="barangJual">
                ...
                <div className="listBarang">
                  <ListBarangStore products={products} />
                </div>
...
const ListBarangStore = ({ products }) => {
...
function Barang({ gambarBarangR, namaBarangR, hargaBarangR, ratingBarangR, barangTerjualR, productId }) {
      ...
      <div className="barangContainer">
        ...
        <div className="deskripsiBarang">
          ...
          <div className="alignRight">
            <button onClick={() => handleAddToCart(productId)}>Beli</button>
          </div>
        </div>
      </div>
    </>
